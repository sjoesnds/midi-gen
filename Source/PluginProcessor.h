...
public:
    ...
    float getVariationScore(int varIndex) const;
...
private:
    ...
    // --- Learning system ---
    struct VariationFeedback {
        int likes = 0;
        int dislikes = 0;
        float avgDensity = 0.5f;
        float avgEnergy = 0.5f;
        float avgComplexity = 0.5f;
    };
    std::vector<VariationFeedback> feedback;
